...
from biodata.serializers import ArtikelSerializer 
...
def artikel(request):
    ...
    url = 'http://localhost:8000/dashboard/api/artikel/list/33f01de908c1fea916bc683f389ce0673a847adb9fe071ae0b71c32e01d58e70'
    #basic auth
    user_login = "arjunarey"
    user_password = "arjunarey23"
...
def _cek_auth(request, x_api_key):
    ...
    # jika set key errror maka jalankan ini 
         content = {
            'status': False,
